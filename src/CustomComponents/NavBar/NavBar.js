import globalStyles from "../../GlobalStyleSheet.css";
            ...
            <nav>
                <ul>
                   ...
                   <li className="logo"> <a href="/BaraHome">CryptoBara</a></li>
                    ...
                    <li className="items"><a href="/BaraLogIn"><Button1 description="LOG IN" color={globalStyles.orange} height="40px" width="120px"></Button1></a></li>
                    <li>
